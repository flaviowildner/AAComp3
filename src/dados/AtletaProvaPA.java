...
public class AtletaProvaPA {
    ...
    public static ResultSet findAtletasProva(String nome_prova) throws SQLException, ClassNotFoundException {
        return Banco.executeReturn("SELECT a.matricula, a.nome, b.tempo, b.ponto from atleta as a JOIN atletaprova as b on" +
    ...
    public static void inserirPonto(String nome_prova, String matricula_atleta, String ponto) throws SQLException, ClassNotFoundException {
        Banco.execute("UPDATE atletaprova SET  ponto = '" + ponto + "' WHERE nome_prova = '" + nome_prova + "' and matricula_atleta = '" + matricula_atleta + "' ;");
    }

    public static ResultSet findPosicoes(String nome_prova) throws SQLException, ClassNotFoundException {
        return Banco.executeReturn("SELECT * FROM atletaprova WHERE nome_prova = '" + nome_prova + "' order by tempo nulls last;");
    }
}
